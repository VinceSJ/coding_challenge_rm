...
import q1b  # The thing we're testing, should be in this folder.
    # Note, because q1b has some print statements, I believe they get spit out in the console prior to test. Ignore it.
import unittest  # We came to test!


############
# Re-Using testing from q1a here.
# Replacing every instance of q1a.fizzbuzz_translator with q1b.recursive_fizzbuzz_translator
# Because of weirdness with mutable lists and default, we must also pass a seoncdary argument of an empty list.
############
...
class Test_fizzbuzz_translator(unittest.TestCase):
    ...
    def test_empty_list(self):
        ...
        actual_result = q1b.recursive_fizzbuzz_translator(list_of_numbers, [])  # Actually running the function
